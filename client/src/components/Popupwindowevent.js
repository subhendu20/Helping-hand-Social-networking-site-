...
function Popupwindowevent() {
  ...
  return (
          <form className={!subloading?'eventform':'eventform eventform-load'} onSubmit={post}>
          ...
          <span className="title"><input type="text" name='topic' placeholder='Title' onChange={change} className='form-input-pop' required/></span>
          <span className='headings'>Location(Area/city/state)</span>
          <span className="title"><input type="text" name='location' placeholder='Location' onChange={change} className='form-input-pop' required /></span>
          <span className='headings'>Write a brief description</span>
          <span className="textarea"><textarea name="description" id="" cols="30" rows="8" placeholder='Description' className='form-input-pop' onChange={change} required></textarea></span>
